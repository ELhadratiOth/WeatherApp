...
def getLocation():
    if len(searchBar.get()) == 0:
        ...
        # global latitude ,  longitude  , lastT , img , dataDic , AirData , elem11
        if location:
...
def create_toplevel_window():
    ...
    aqiVal = ctk.CTkLabel(frameTop, width=100, height=15, text=AirData[0], font=('Davish Medium', 65),
                          text_color=AirData[11])
...
my_image = ImagAdd(img, 100)
currentWlabel11 = ctk.CTkLabel(currentW, image=my_image, text="", width=120, height=150, bg_color='#263138',
                               font=('Mountain', 50))
currentWlabel11.place(relx=0.07, rely=0.02)

frameTT = ctk.CTkFrame(currentW, width=104, height=52, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
...
frameTT = ctk.CTkFrame(elem1, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
...
frameTT = ctk.CTkFrame(elem2, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
frameTT.place(relx=0.15, rely=0.08)
...
frameTT = ctk.CTkFrame(elem3, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
frameTT.place(relx=0.15, rely=0.08)
...
frameTT = ctk.CTkFrame(elem4, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
frameTT.place(relx=0.15, rely=0.08)
...
frameTT = ctk.CTkFrame(elem5, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
frameTT.place(relx=0.15, rely=0.08)
...
frameTT = ctk.CTkFrame(elem6, width=84, height=36, border_width=3, border_color="#000000", corner_radius=30,
                       fg_color='#06151e')
frameTT.place(relx=0.15, rely=0.08)
...
aqiButtun = ctk.CTkButton(currentW, image=my_image, text="AQI " + str(AirData[0]), bg_color='#263138',
                          fg_color='#16191c'
                          , border_width=2, corner_radius=10, border_color='#000000',
